...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'strategy_oid'); ?>
		<?php echo $form->textField($model,'strategy_oid',array('size'=>20,'maxlength'=>20)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'strategy_description'); ?>
